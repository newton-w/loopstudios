    ...
    return (
        <div className='flex flex-col items-center justify-center px-6 py-24 lg:flex-row xl:container xl:mx-auto'>
            ...
            >
                ...
                <img src={personMobile} alt="A person wearing vr headsets playing a game" />
            </motion.picture>
            <motion.div
            
            className=' flex flex-col gap-7 px-7 text-center lg:w-[40.625rem] lg:h-[25.313rem] lg:bg-white lg:justify-center lg:items-start lg:p-24 lg:translate-x-[-11rem] lg:translate-y-40 lg:mb-24'>
