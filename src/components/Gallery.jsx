        ...
        <div className='flex flex-col items-center justify-center pb-14 lg:grid xl:container xl:mx-auto'>
            ...
            <div className='z-0 flex flex-col items-center justify-center space-y-6  md:grid md:grid-cols-2 md:gap-6 md:items-center md:justify-center lg:grid-cols-4 lg:space-y-0 lg:justify-items-center'>
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className='text-white w-auto max-w-[20.438rem] h-[7.5rem] md:max-w-[25.438rem] lg:h-[28.175rem] lg:w-[16rem] bg-black cursor-pointer duration-300 hover:text-black hover:bg-white'>
                    <picture>
                ...
                <motion.div
                    ...
                    transition={{ type: "spring", stiffness: 70 }}
                    viewport={{ once: true }}
                    className='text-white w-auto max-w-[20.438rem]  md:max-w-[25.438rem] h-[7.5rem] lg:h-[28.175rem] lg:w-[16rem] bg-black cursor-pointer duration-300 hover:text-black hover:bg-white'>
                    <picture >
            ...
            <motion.div
                ...
                transition={{ type: "spring", stiffness: 70 }}
                viewport={{ once: true }}
                className=' w-40 flex items-center justify-center font-JosefinSans font-light text-black border-2 border-VeryDarkGrey px-9 py-3 mt-8 cursor-pointer hover:bg-black hover:text-white duration-300 lg:hidden lg:float-right'>
                SEE ALL
            </motion.div>
        </div>
    )
